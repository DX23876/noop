...
enum AppChangelog {
    ...
    static let releases: [Release] = [
        ...
        Release(
            ...
            date: "June 2026",
            items: [
                "**NOOP is back on GitHub** - and so is **Check for updates**. The in-app update check and the **Settings → About** \"project home\" link now point at github.com/DX23876/noop, where this fork's releases live. It's still on-device and only runs when you tap - nothing about you is ever sent.",
            ]),
        Release(
            version: "5.2.5",
