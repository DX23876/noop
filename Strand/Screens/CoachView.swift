...
struct CoachView: View {
    ...
    private func evidenceLabel(_ tool: CoachTool) -> some View {
        ...
        case .bodyMetrics:             Text("Body & energy")
        ...
        case .logWeight:               Text("Weigh-in")
        case .energyBalance:           Text("Energy")
    ...
    private func evidenceDetail(_ tool: CoachTool) -> some View {
        ...
        case .bodyMetrics:             Text("Your measurements, and the three daily-energy estimates with their sources")
        ...
        case .logWeight:               Text("A weigh-in you logged")
        case .energyBalance:           Text("Today's energy burn and how much was measured")
