...
final class LiquidBatteryDisplayTests: XCTestCase {
    ...
    func testImpossiblePercentagesAreClampedForEveryDashboardHeader() {
        XCTAssertEqual(Display.resolve(activeIsWhoop: true, connected: true, batteryPct: -8, charging: false),
                       .charge(pct: 0, charging: false))
        XCTAssertEqual(Display.resolve(activeIsWhoop: true, connected: true, batteryPct: 140, charging: false),
