...
final class WorkoutNamespaceTests: XCTestCase {
    ...
    func testTheReadIncludesImportNamespaces() {
        ...
        XCTAssertTrue(ids.contains("hevy"), "API-synced Hevy sessions are listed in their own lane")
    }
    ...
    func testDeleteNeverReachesImportNamespaces() {
        ...
        XCTAssertFalse(ids.contains("hevy"), "API-synced Hevy history must survive a delete")
    }
