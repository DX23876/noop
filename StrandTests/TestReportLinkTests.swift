...
/// labels, with every component percent-encoded. The repo is this fork, DX23876/noop — a report about
/// a build published here belongs in this tracker, and the ids come from this repo's bug_report.yml.
final class TestReportLinkTests: XCTestCase {
    ...
    func testSleepProfileURLEncodesEveryFieldAndLabel() {
        ...
        XCTAssertTrue(s.hasPrefix("https://github.com/DX23876/noop/issues/new?"))
