...
DE: dict[str, str] = {
    ...
    "Your live heart rate is working from the strap, and recovery, strain and sleep build from it over your next few nights of wear, sharpening as it learns your baseline. Want your full history instantly? Import your WHOOP export in Data Sources and it backfills in about a minute.": "Deine Live-Herzfrequenz funktioniert bereits vom Strap, und Erholung, Belastung und Schlaf bauen sich daraus über deine nächsten Nächte am Handgelenk auf und werden genauer, während er deine Basislinie lernt. Willst du deinen vollen Verlauf sofort? Importiere deinen WHOOP-Export unter „Datenquellen“, und er füllt sich in etwa einer Minute rückwirkend.",
    ...
    # --- Coach goal / plan / journey / usage (fork: P3–P7) -------------------
    "About that pace": "Zu diesem Tempo",
    "Goal type": "Zielart",
    "Save anyway": "Trotzdem speichern",
    "Share this with the coach": "Mit dem Coach teilen",
    "Target date": "Zieldatum",
    "What are you working towards?": "Worauf arbeitest du hin?",
    "Why this pace?": "Warum dieses Tempo?",
    "Without one I can't tell you how you're tracking.": "Ohne Ziel kann ich dir nicht sagen, wo du stehst.",
    "This is faster than usually recommended. It's your call — tell me why and I'll note it, so I coach you through it instead of arguing with you every week.": "Das ist schneller als üblicherweise empfohlen. Deine Entscheidung — sag mir warum, und ich notiere es. So begleite ich dich dabei, statt jede Woche mit dir zu diskutieren.",
    "With a target and a date I can tell you where you stand, not just how you slept. Entirely optional — everything else works without it.": "Mit Zielwert und Datum kann ich dir sagen, wo du stehst — nicht nur, wie du geschlafen hast. Völlig optional: alles andere funktioniert auch ohne.",
    "I'll track your weight and plan your training around it — but I have no nutrition data, and that's where most of weight change is decided. I won't pretend otherwise.": "Ich verfolge dein Gewicht und plane dein Training danach — aber ich habe keine Ernährungsdaten, und dort entscheidet sich der Großteil einer Gewichtsveränderung. Ich tue nicht so, als wäre es anders.",
    "I can hold this goal and shape your training around it, but I can't measure it from your strap — so I won't invent progress numbers for it.": "Ich kann dieses Ziel festhalten und dein Training danach ausrichten, aber vom Strap messen kann ich es nicht — also erfinde ich auch keine Fortschrittszahlen dafür.",
    "Didn't happen": "Ausgefallen",
    "How hard": "Wie hart",
    "No plan yet": "Noch kein Plan",
    "Set": "Festlegen",
    "Set a time": "Uhrzeit festlegen",
    "Swap": "Tauschen",
    "Swap session": "Einheit tauschen",
    "What your history says": "Was deine Historie sagt",
    "Your plan": "Dein Plan",
    "Ask the coach what to do this week. Anything it suggests lands here for your yes first — nothing gets scheduled behind your back.": "Frag den Coach, was diese Woche ansteht. Alles, was er vorschlägt, landet zuerst hier für dein Ja — nichts wird hinter deinem Rücken verplant.",
    "Last question": "Letzte Frage",
    "View your journey": "Deine Reise ansehen",
    "Changes to this goal": "Änderungen an diesem Ziel",
    "Milestones": "Meilensteine",
    "No goal set": "Kein Ziel gesetzt",
    "Nothing planned yet.": "Noch nichts geplant.",
    "Nothing yet — that's normal for a goal this new.": "Noch nichts — bei einem so neuen Ziel ganz normal.",
    "Planned vs actual": "Geplant vs. tatsächlich",
