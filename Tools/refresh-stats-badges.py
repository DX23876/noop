...
Reads counts from the GitHub API (https://api.github.com/repos/DX23876/noop) using the token
...
API="https://api.github.com/repos/DX23876/noop"
...
open_issues=search_count("repo:DX23876/noop is:issue is:open")
resolved=search_count("repo:DX23876/noop is:issue is:closed")
