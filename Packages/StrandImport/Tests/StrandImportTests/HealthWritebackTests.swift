...
final class HealthWritebackTests: XCTestCase {
    ...
    func testANightEndingAfterTheNewestHeartRateIsNotHeldOpen() {
        XCTAssertFalse(HealthWriteback.nightIsStillOpen(endTs: 2_000, newestHeartRateTs: 1_900, now: 2_100))
    }

    func testAFutureNightEndIsNotHeldOpen() {
        XCTAssertFalse(HealthWriteback.nightIsStillOpen(endTs: 2_000, newestHeartRateTs: 2_000, now: 1_900))
    }
