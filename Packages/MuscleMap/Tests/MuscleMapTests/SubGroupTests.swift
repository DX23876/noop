...
final class SubGroupTests: XCTestCase {
    ...
    func testNewMuscleDisplayNames() {
        ...
        XCTAssertEqual(Muscle.serratus.displayName(locale: english), "Serratus")
        XCTAssertEqual(Muscle.rhomboids.displayName(locale: english), "Rhomboids")
    }
    ...
    func testSubGroupDisplayNames() {
        let english = Locale(identifier: "en")
        XCTAssertEqual(Muscle.ankles.displayName(locale: english), "Ankles")
        XCTAssertEqual(Muscle.adductors.displayName(locale: english), "Adductors")
        XCTAssertEqual(Muscle.neck.displayName(locale: english), "Neck")
        ...
        XCTAssertEqual(Muscle.lowerChest.displayName(locale: english), "Lower Chest")
        XCTAssertEqual(Muscle.innerQuad.displayName(locale: english), "Inner Quad")
        XCTAssertEqual(Muscle.outerQuad.displayName(locale: english), "Outer Quad")
        XCTAssertEqual(Muscle.upperAbs.displayName(locale: english), "Upper Abs")
        XCTAssertEqual(Muscle.lowerAbs.displayName(locale: english), "Lower Abs")
        XCTAssertEqual(Muscle.frontDeltoid.displayName(locale: english), "Front Deltoid")
        XCTAssertEqual(Muscle.rearDeltoid.displayName(locale: english), "Rear Deltoid")
        XCTAssertEqual(Muscle.upperTrapezius.displayName(locale: english), "Upper Trapezius")
        XCTAssertEqual(Muscle.lowerTrapezius.displayName(locale: english), "Lower Trapezius")
    }
